...
def print_table_three(true, pred, devtrue, devpred, best_trial_id, best_trial_loss):
    ...
    if best_trial_id is not None:
        ...
        print "%-12s%-12.4f%-12.4f%-12.4f%-12.4f%-12.4f%-12.4f" % (("Development", dev_accuracy, dev_macroavg_prfs[2]) + tuple(dev_perclass_prfs[2]))
        print "%-12s%-12.4f%-12.4f%-12.4f%-12.4f%-12.4f%-12.4f" % (("Testing", test_accuracy, macroavg_prfs[2]) + tuple(perclass_prfs[2]))
